...
namespace OpenAI_API.Models
{
	...
	public class Model
	{
		...
		/// </summary>
		public static Model BabbageText => new Model("text-babbage-002") { OwnedBy = "openai" };
		...
		public static Model ChatGPTTurbo0125 => new Model("gpt-3.5-turbo-0125") { OwnedBy = "openai" };
